...
import com.example.tictacjournalofficial.databinding.ActivityTicTacToeBinding;
...
public class TicTacToe extends AppCompatActivity {
    ...
    private void performAction(ImageView  imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            ...
            if (checkResults()) {
                ResultDialog resultDialog = new ResultDialog(TicTacToe.this, binding.playerOneName.getText().toString()
